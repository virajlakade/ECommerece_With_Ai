...
const AddProduct = () => {
  ...
  const generateDescription = async () => {
    if (!product.name.trim() || !product.category) {
      toast.warning(
          "Please enter product name and select a category first"
      );
      return;
    }
  ...
  const handleGenerate = async () => {
    ...
    try {
      const response = await axios.post(
          `${baseUrl}/api/product/generate-product`,
          null,
          {
            params: {
              query: aiPrompt,
      ...
      toast.error(
          "Error generating product. Please try again."
      );
    } finally {
                ...
                >
                  ...
                  <div className="col-12">
                    ...
                    {!canGenerateDescription && (
                        <div className="form-text text-muted">
                          ...
                          Fill in product name and category to
                  ...
                  <div className="col-md-8">
                    ...
                    <div className="form-text">
                      Upload a product image (JPG, PNG) or
                ...
                <div className="modal-content">
                  ...
                  <div className="modal-body">
                    ...
                    <p className="text-muted">
                      ...
                      and our AI will generate product details
                      for you.
                    </p>
                    ...
                    <div className="form-text mb-3">
                      <i className="bi bi-info-circle me-1"></i>
                      The more detailed your description, the
                      better the generated product will be.
                    </div>
